...
document.writeln("<h1>Sum of " + num1 + " and " + num2 + " is " + result + "</h1>")

//2.
var result = num1 - num2;
document.writeln("<h1>Subtraction of " + num1 + " and " + num2 + " is " + result + "</h1>")
var result = num1 * num2;
document.writeln("<h1>Multiplication of " + num1 + " and " + num2 + " is " + result + "</h1>")
var result = num1 / num2;
document.writeln("<h1>Division of " + num1 + " and " + num2 + " is " + result + "</h1>")
...
document.writeln("<h1>Total cost to buy 5 tickets to a movie is " + totalCost + " PKR</h1>")
...
document.writeln("<h1>" + celsiusValue + "°C is " + fahrenheitValue + "°F</h1>")
var fahrenheitValue = 70;
var celsiusValue = (fahrenheitValue - 32) * 5 / 9;
document.writeln("<h1>" + fahrenheitValue + "°F is " + celsiusValue + "°C</h1>")
...
var usDollars = 10;
var saudiRiyals = 25;
var pkrFromDollars = usDollars * 104.80;
...
document.writeln(`<p>You will need ${result} ${favoriteSnack} to last you until the ripe old age of ${maximumAge}”.</p>`)
